...
registerBlockType('multiposter/application-form', {
    title: __('Application Form', 'jobit-vacancies-for-multiposter'),
    icon: 'email',
    category: 'widgets',
    attributes: {
        ...
        return (
            <div {...blockProps}>
                ...
                <div style={{ padding: '20px', background: '#f0f0f0', textAlign: 'center' }}>
                    <strong>{__('Application Form', 'jobit-vacancies-for-multiposter')}</strong>
                    {effectiveId ? (
